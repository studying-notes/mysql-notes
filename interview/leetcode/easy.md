---
date: 2020-10-20 23:44:24+08:00  # 创建日期
author: "Rustle Karl"  # 作者

title: "LeetCode数据库解题（简单级别）"  # 文章标题
url:  "posts/mysql/interview/leetcode/easy"  # 设置网页永久链接
...
- [找出合作多次的演员和导演](#找出合作多次的演员和导演)
- [广告点击率](#广告点击率)
- [平均销售价格](#平均销售价格)
- [找出只出现单次的最大值](#找出只出现单次的最大值)
- [相邻空座位](#相邻空座位)
- [区间统计](#区间统计)
- [点餐最多的顾客](#点餐最多的顾客)
- [团队人数](#团队人数)
...
- [第一次登录的时间](#第一次登录的时间)
- [第一次登录用的设备](#第一次登录用的设备)
- [统计某天销售的数量和商品名称](#统计某天销售的数量和商品名称)
- [立即配送比例](#立即配送比例)
- [找出文章评论数量](#找出文章评论数量)
- [统计不同年份的售价](#统计不同年份的售价)
- [统计项目人员平均工作经验](#统计项目人员平均工作经验)
- [找出人员最多的项目](#找出人员最多的项目)
- [质量百分比](#质量百分比)
- [时间减法](#时间减法)
- [销售数据分析](#销售数据分析)
- [没有卖给过某公司的销售员](#没有卖给过某公司的销售员)
- [第二高的薪水](#第二高的薪水)
- [最短距离](#最短距离)
- [学生与考试](#学生与考试)
- [旅途长短](#旅途长短)
